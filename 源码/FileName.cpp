...
public:
	...
	void Move()
	{
		...
		if (position.y + FRAME_HEIGHT > WINDOW_HEIGHT)position.y = WINDOW_WIDTH - FRAME_HEIGHT;
...
public:
	Enemy()
	{
		...
		case SpawnEdge::Up:
			...
			position.y = rand() % -FRAME_HEIGHT;
			break;
		case SpawnEdge::Down:
			position.x = rand() % WINDOW_WIDTH;
			position.y = WINDOW_HEIGHT + rand() % -FRAME_HEIGHT;
			break;
		case SpawnEdge::Left:
			position.x = rand() % -FRAME_WIDTH;
			position.y = rand() % WINDOW_HEIGHT;
			break;
		case SpawnEdge::Right:
			position.x = WINDOW_WIDTH+rand() % -FRAME_WIDTH;
			position.y = rand() % WINDOW_HEIGHT;
			break;
		}
	}
